/**
 * Contenido de la landing del Cmax Air X2 — unica fuente de verdad del
 * producto.
 *
 * Reglas:
 * - Ningun componente hardcodea copy, precios, specs ni rutas de imagen.
 * - `deliveryDate` es LA unica fecha de entrega de toda la pagina. Mientras
 *   sea null, las secciones que la mencionan muestran su `fallback` neutro.
 * - No inventar datos: todo lo que esta aca lo confirmo el cliente.
 * - Copy en ingles: el sitio y el mercado de Cmax System son en ingles.
 */
...
export const airX2: AirX2Content = {
